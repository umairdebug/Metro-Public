    ...
    public partial class M001_Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductDisplaySection", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientRemarks = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    AdminRemarks = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    AppUsersID = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    DbEntryTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                name: "ProductProductDisplaySection",
                columns: table => new
                {
                    DisplaySectionsId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ProductsId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductProductDisplaySection", x => new { x.DisplaySectionsId, x.ProductsId });
                    table.ForeignKey(
                        name: "FK_ProductProductDisplaySection_ProductDisplaySection_DisplaySectionsId",
                        column: x => x.DisplaySectionsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductProductSale", x => new { x.ProductsId, x.SalesId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductProductDisplaySection_ProductsId",
                table: "ProductProductDisplaySection",
                column: "ProductsId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductProductSale_SalesId",
